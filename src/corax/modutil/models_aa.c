...
#include "corax_modutil.h"

/* general single-matrix models */
const pllmod_subst_model_t M_DAYHOFF = {
    "DAYHOFF", 20, pll_aa_rates_dayhoff, pll_aa_freqs_dayhoff, NULL, NULL, 0};
const pllmod_subst_model_t M_LG = {
    "LG", 20, pll_aa_rates_lg, pll_aa_freqs_lg, NULL, NULL, 0};
const pllmod_subst_model_t M_DCMUT = {
    "DCMUT", 20, pll_aa_rates_dcmut, pll_aa_freqs_dcmut, NULL, NULL, 0};
const pllmod_subst_model_t M_JTT = {
    "JTT", 20, pll_aa_rates_jtt, pll_aa_freqs_jtt, NULL, NULL, 0};
const pllmod_subst_model_t M_MTREV = {
    "MTREV", 20, pll_aa_rates_mtrev, pll_aa_freqs_mtrev, NULL, NULL, 0};
const pllmod_subst_model_t M_WAG = {
    "WAG", 20, pll_aa_rates_wag, pll_aa_freqs_wag, NULL, NULL, 0};
const pllmod_subst_model_t M_RTREV = {
    "RTREV", 20, pll_aa_rates_rtrev, pll_aa_freqs_rtrev, NULL, NULL, 0};
const pllmod_subst_model_t M_CPREV = {
    "CPREV", 20, pll_aa_rates_cprev, pll_aa_freqs_cprev, NULL, NULL, 0};
const pllmod_subst_model_t M_VT = {
    "VT", 20, pll_aa_rates_vt, pll_aa_freqs_vt, NULL, NULL, 0};
const pllmod_subst_model_t M_BLOSUM62 = {"BLOSUM62",
                                         20,
                                         ...
                                         NULL,
                                         0};
const pllmod_subst_model_t M_MTMAM    = {
    "MTMAM", 20, pll_aa_rates_mtmam, pll_aa_freqs_mtmam, NULL, NULL, 0};
const pllmod_subst_model_t M_MTART = {
    "MTART", 20, pll_aa_rates_mtart, pll_aa_freqs_mtart, NULL, NULL, 0};
const pllmod_subst_model_t M_MTZOA = {
    "MTZOA", 20, pll_aa_rates_mtzoa, pll_aa_freqs_mtzoa, NULL, NULL, 0};
const pllmod_subst_model_t M_PMB = {
    "PMB", 20, pll_aa_rates_pmb, pll_aa_freqs_pmb, NULL, NULL, 0};
const pllmod_subst_model_t M_HIVB = {
    "HIVB", 20, pll_aa_rates_hivb, pll_aa_freqs_hivb, NULL, NULL, 0};
const pllmod_subst_model_t M_HIVW = {
    "HIVW", 20, pll_aa_rates_hivw, pll_aa_freqs_hivw, NULL, NULL, 0};
const pllmod_subst_model_t M_JTTDCMUT = {"JTT-DCMUT",
                                         20,
                                         ...
                                         NULL,
                                         0};
const pllmod_subst_model_t M_FLU      = {
    "FLU", 20, pll_aa_rates_flu, pll_aa_freqs_flu, NULL, NULL, 0};
const pllmod_subst_model_t M_STMTREV = {
    "STMTREV", 20, pll_aa_rates_stmtrev, pll_aa_freqs_stmtrev, NULL, NULL, 0};
const pllmod_subst_model_t M_DEN = {
    "DEN", 20, pll_aa_rates_den, pll_aa_freqs_den, NULL, NULL, 0};

/* LG4M components */
const pllmod_subst_model_t M_LG4M1 = {
    "LG4M1", 20, pll_aa_rates_lg4m[0], pll_aa_freqs_lg4m[0], NULL, NULL, 0};
const pllmod_subst_model_t M_LG4M2 = {
    "LG4M2", 20, pll_aa_rates_lg4m[1], pll_aa_freqs_lg4m[1], NULL, NULL, 0};
const pllmod_subst_model_t M_LG4M3 = {
    "LG4M3", 20, pll_aa_rates_lg4m[2], pll_aa_freqs_lg4m[2], NULL, NULL, 0};
const pllmod_subst_model_t M_LG4M4 = {
    "LG4M4", 20, pll_aa_rates_lg4m[3], pll_aa_freqs_lg4m[3], NULL, NULL, 0};

/* LG4X components */
const pllmod_subst_model_t M_LG4X1 = {
    "LG4X1", 20, pll_aa_rates_lg4x[0], pll_aa_freqs_lg4x[0], NULL, NULL, 0};
const pllmod_subst_model_t M_LG4X2 = {
    "LG4X2", 20, pll_aa_rates_lg4x[1], pll_aa_freqs_lg4x[1], NULL, NULL, 0};
const pllmod_subst_model_t M_LG4X3 = {
    "LG4X3", 20, pll_aa_rates_lg4x[2], pll_aa_freqs_lg4x[2], NULL, NULL, 0};
const pllmod_subst_model_t M_LG4X4 = {
    "LG4X4", 20, pll_aa_rates_lg4x[3], pll_aa_freqs_lg4x[3], NULL, NULL, 0};

const pllmod_subst_model_t M_PROTGTR = {
...
const int PROT_MODELS_COUNT =
    sizeof(prot_model_list) / sizeof(pllmod_subst_model_t *);

/* mixture models */
const pllmod_subst_model_t *lg4m_matrices[] = {
    &M_LG4M1, &M_LG4M2, &M_LG4M3, &M_LG4M4};
const pllmod_mixture_model_t M_LG4M = {"LG4M",
                                       4,
                                       (pllmod_subst_model_t **)lg4m_matrices,
                                       NULL,
                                       NULL,
                                       PLLMOD_UTIL_MIXTYPE_GAMMA};

const pllmod_subst_model_t *lg4x_matrices[] = {
    &M_LG4X1, &M_LG4X2, &M_LG4X3, &M_LG4X4};
const pllmod_mixture_model_t M_LG4X = {"LG4X",
                                       4,
                                       (pllmod_subst_model_t **)lg4x_matrices,
                                       NULL,
                                       NULL,
                                       PLLMOD_UTIL_MIXTYPE_FREE};

static const pllmod_mixture_model_t *protmix_model_list[] = {&M_LG4M, &M_LG4X};

const int PROTMIX_MODELS_COUNT =
    sizeof(protmix_model_list) / sizeof(pllmod_mixture_model_t *);
