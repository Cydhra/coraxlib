...
CORAX_EXPORT void
corax_core_update_clv_ii_16x16_avx2(unsigned int sites,
                                    unsigned int rate_cats,
                                    double * parent_clv,
                                    unsigned int * parent_scaler,
                                    const double * left_clv,
                              ...
                              unsigned int        attrib)
{
  ...
  {
    corax_core_update_clv_ii_16x16_avx2(sites,
                                        rate_cats,
                                        parent_clv,
                                        parent_scaler,
                                        left_clv,
...
CORAX_EXPORT void
corax_core_update_clv_repeats_16x16_avx2(unsigned int parent_sites,
                                         ...
                                         unsigned int attrib)
{
  ...
  else
  {
    ...
    /* add up the scale vector of the two children if available */
    if (scale_mode == 2)
      corax_fill_parent_scaler_repeats_per_rate(parent_sites, rate_cats, parent_scaler, parent_id_site,
        left_scaler, left_site_id, right_scaler, right_site_id);
    else
      corax_fill_parent_scaler_repeats(parent_sites, parent_scaler, parent_id_site,
        left_scaler, left_site_id, right_scaler, right_site_id);
  }
                                           ...
                                           unsigned int        attrib)
{
  ...
  if (states == 16)
  {
    return corax_core_update_clv_repeats_16x16_avx2(parent_sites,
                                                    left_sites,
                                                    right_sites,
                                                    rate_cats,
                                                    parent_clv,
