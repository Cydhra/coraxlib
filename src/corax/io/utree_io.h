...
/**
 * This function will create a corax_utree_t from a newick _file_. If there is an
 * error, the function will return CORAX_ERROR (which happens to be 0). If a file
...
/**
 * This function will create a corax_utree_t from a newick _file_. If there is an
 * error, the function will return CORAX_ERROR (which happens to be 0). The
 * tree contained in the file is allowed to be rooted or unrooted.
 *
 * @ingroup corax_utree_t
 */
CORAX_EXPORT corax_utree_t *corax_utree_parse_newick_rooted(const char *filename);
 ...
 * @ingroup corax_utree_t
 */
CORAX_EXPORT corax_utree_t *corax_utree_parse_newick_unroot(const char *filename);
 ...
 * @ingroup corax_utree_t
 */
CORAX_EXPORT corax_utree_t *corax_utree_parse_newick_string_rooted(const char *s);

/**
 * @ingroup corax_utree_t
 * This function will create a corax_utree_t from a newick _string_. If there is
 * an error, the function will return CORAX_ERROR (which happens to be 0). If the
 * tree contained in the string is rooted, it will **unroot** the tree, and
 *
 * @ingroup corax_utree_t
 * return a rooted tree.
 */
CORAX_EXPORT corax_utree_t *corax_utree_parse_newick_string_unroot(const char *s);
...
CORAX_EXPORT void corax_utree_show_ascii(const corax_unode_t *tree, int options);
