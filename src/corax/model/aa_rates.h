#ifndef CORAX_MODEL_AA_RATES_H_
#define CORAX_MODEL_AA_RATES_H_
...
CORAX_EXPORT extern const double corax_aa_rates_mtmet[190];
CORAX_EXPORT extern const double corax_aa_rates_mtinv[190];
CORAX_EXPORT extern const double corax_aa_rates_mtver[190];
...
CORAX_EXPORT extern const double corax_aa_rates_flavi[190];
...
CORAX_EXPORT extern const double corax_aa_freqs_mtmet[20];
CORAX_EXPORT extern const double corax_aa_freqs_mtinv[20];
CORAX_EXPORT extern const double corax_aa_freqs_mtver[20];
...
CORAX_EXPORT extern const double corax_aa_freqs_flavi[20];
